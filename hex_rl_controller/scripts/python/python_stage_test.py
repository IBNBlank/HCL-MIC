...
class StageTest():
    ...
    def run(self):
        ...
        # reset agent
        action_list = None
        observation = self.__stage_env.reset_agent()

        #### test ####
        while not group_terminal and not self.__stage_env.is_shutdown():
...
if __name__ == '__main__':
    ...
    #### stage1 class ####
    stage_test = StageTest(comm=mpi_comm,
